<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/notice/dispatch.html";i:1554963582;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <div class="layui-fluid" class="layui-form">
    <div class="layui-card">
      <div class="layui-row layui-col-space5">
        <?php if(empty($dispatch) || (($dispatch instanceof \think\Collection || $dispatch instanceof \think\Paginator ) && $dispatch->isEmpty())): ?>
        <div class="layui-col-md12" style="border-bottom:1px solid #eeeeee;text-align:center;padding: 10px;line-height:40px;">
          暂无待办消息
        </div>
        <?php else: foreach($dispatch as $s): ?>
        <div class="layui-col-md12" style="border-bottom:1px solid #eeeeee;">
          ...
          <div class="layui-col-md11">
            <div class="layui-col-md6" style="padding: 10px;line-height:40px;text-align: left;">
              <?php if($user_id == 1): ?><?php echo str_replace('给您','给(<span style="color:#1E9FFF">'.$s['user_name'].'</span>)',$s['title']); else: ?><?php echo $s['title']; endif; ?>
            </div>

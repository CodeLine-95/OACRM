<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/team/edit_admin.html";i:1553853961;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="layui-card">
          ...
          <div class="layui-form layui-card-body" pad15>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="user_name" id="user_name" lay-verify="user_name|required" value="<?php echo $admin['user_name']; ?>"  class="layui-input">
                </div>

                <label class="layui-form-label" for="staff_idcard">身份证号</label>
                <div class="layui-input-inline">
                  <input type="text" name="staff_idcard" id="staff_idcard" value="<?php echo $admin['staff_idcard']; ?>" class="layui-input">
                </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="float:left;width:70%;margin-left: 100px;">
              ...
              <div class="layui-form-item">
                ...
                <label class="layui-form-label" for="staff_status">员工状态</label>
                <div class="layui-input-inline">
                  <select class="layui-input" name="staff_status">
                    <option value="1" <?php if($admin['staff_status'] == 1): ?> selected <?php endif; ?>>全职</option>
                    <option value="2" <?php if($admin['staff_status'] == 2): ?> selected <?php endif; ?>>离职</option>
                    <option value="3" <?php if($admin['staff_status'] == 3): ?> selected <?php endif; ?>>休假</option>
                  </select>
                </div>
			         </div>
              ...
              <div class="layui-form-item">
                  ...
                  <?php endforeach; endif; else: echo "" ;endif; ?>
          				<input type="text" id="inputTags" style="border:1px solid #e6e6e6;" class="layui-input" placeholder="回车生成技能标签" autocomplete="off" value="">
              ...
              <div class="layui-form-item">
                <div class="layui-input-block">
                    <label class="layui-form-label"><button class="layui-btn" lay-submit lay-filter="add">编辑员工</button></label>
                </div>
              </div>

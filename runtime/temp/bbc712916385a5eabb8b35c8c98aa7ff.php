<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/index/console.html";i:1553242646;}*/ ?>
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
                  ...
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      <li class="layui-col-xs3">
                        <a lay-href="<?php echo url('user/index'); ?>">
                  ...
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      <li class="layui-col-xs6">
                        <a lay-href="<?php echo url('backlog/index'); ?>" class="layadmin-backlog-body">
                          <h3>待办</h3>
                          <p><cite><?php echo $backlogs; ?></cite></p>
                        </a>
                      </li>
                      <li class="layui-col-xs6">
                        <a lay-href="<?php echo url('backlog/index'); ?>" class="layadmin-backlog-body">
      ...
      <div class="layui-col-md4">
        ...
        <div class="layui-card">
          <div class="layui-card-header">转化报告</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/sales/myorder.html";i:1552299182;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;s:71:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/form.html";i:1554102344;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/order.html";i:1555381618;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
    ...
    <div class="layui-tab layui-tab-brief">
      <crmblok>
        <div style="position: relative;">
          ...
          <!-- <button class="layui-btn" onclick="crm_admin_show('批量转单','<?php echo url('sales/addditch'); ?>')">批量转单</button>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
  	...
  	function retreat(id){
  		layer.confirm("您确定退回该客户吗？",function(){
  			$.ajax({
  				url:"<?php echo url('sales/retreat'); ?>",
  				data:{id:id},
  				type:'post',
  				success:function(data)
  				{

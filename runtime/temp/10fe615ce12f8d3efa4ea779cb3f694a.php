<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/notice/system.html";i:1554963976;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <div class="layui-fluid" class="layui-form">
    <div class="layui-card">
      <div class="layui-row layui-col-space5">
        <?php if(empty($system) || (($system instanceof \think\Collection || $system instanceof \think\Paginator ) && $system->isEmpty())): ?>
        <div class="layui-col-md12" style="border-bottom:1px solid #eeeeee;text-align:center;padding: 10px;line-height:40px;">
          暂无待办消息
        </div>
        <?php else: foreach($system as $s): ?>
    ...
    <script type="text/javascript">
      function content(obj, content, id) {

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/sales/updateorder.html";i:1554271766;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="layui-card">
          ...
          <div class="layui-form layui-card-body" pad15>
              <div class="layui-form-item layui-form-text">
               ...
               <div class="layui-form-item">
                <input type="hidden" name="id" value="<?php echo $client['id']; ?>">
                    ...
                    <div class="layui-input-inline">
                      <input type="text" name="phone" id="phone" class="layui-input" placeholder="请在此输入客户电话" value="<?php echo $client['phone']; ?>">
                    </div>
				        </div>
                <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <textarea name="remark" id="remark" class="layui-textarea" lay-verify="remark|required"><?php echo $client['remark']; ?></textarea>
                </div>
              </div>
  ...
  <script>
    ...
    layui.use(['form','upload','rate'], function(){
      ...
      form.on('submit(add)', function(data){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo url("sales/updateorder"); ?>',
            data: {

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/sales/addorder.html";i:1554271741;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<body onload="last()">
        ...
        <div class="layui-card">
          ...
          <div class="layui-form layui-card-body" pad15>
              ...
              <div class="layui-form-item layui-form-text">
               ...
               <div class="layui-form-item">
                <label class="layui-form-label" for="source">渠道分类</label>
                <div class="layui-input-inline">
  ...
  <script type="text/javascript">
    ...
    layui.use(['form','upload','rate','laydate'], function(){

      var form = layui.form,upload = layui.upload,laydate = layui.laydate;var rate = layui.rate;
          ...
          success:function (data) {
            ...
            if (status.icon == 6){
              layer.msg(status.msg,{icon: status.icon,time:1000},function(){
                  location.href="<?php echo url('sales/myorder'); ?>";
              });
            } else {
              layer.msg(status.msg,{icon: status.icon,time:1000},function(){

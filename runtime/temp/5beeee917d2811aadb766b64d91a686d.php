<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/team/show.html";i:1553672121;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="layui-card">
          ...
          <div class="layui-form layui-card-body layui-fluid" id="component-anim" pad15>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <img src="<?php echo $admin['user_face']; ?>" alt="<?php echo $admin['user_name']; ?>" style="width:300px;">
              </div>
            </div>
          ...
          <div class="layui-form layui-card-body layui-fluid" id="component-anim" pad15>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <?php if(!(empty($admin['firm_business']) || (($admin['firm_business'] instanceof \think\Collection || $admin['firm_business'] instanceof \think\Paginator ) && $admin['firm_business']->isEmpty()))): foreach($admin['firm_business'] as $p): ?>
                <?php echo $p['name']; ?>&nbsp;&nbsp;&nbsp;
          ...
          <div class="layui-form-item layui-form-text">
            <h3 style="width: 90px;height: 40px;line-height: 40px;border-bottom: 2px solid #1E9FFF;margin: 0 auto;">我的账号</h3>
          </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/guanjia.jutui.org/public/../application/admin/view/notice/backlog.html";i:1554963593;s:72:"/home/wwwroot/guanjia.jutui.org/application/admin/view/public/title.html";i:1551945361;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <div class="layui-fluid" class="layui-form">
    <div class="layui-card">
      <div class="layui-row layui-col-space5">
        <?php if(empty($backlog) || (($backlog instanceof \think\Collection || $backlog instanceof \think\Paginator ) && $backlog->isEmpty())): ?>
        <div class="layui-col-md12" style="border-bottom:1px solid #eeeeee;text-align:center;padding: 10px;line-height:40px;">
          暂无待办消息
        </div>
        <?php else: foreach($backlog as $s): ?>
